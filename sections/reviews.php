...
if (isset($_POST['submit'])) {
    ...
    if (array_filter($errors)) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $result = mysqli_query($conn, $sql);
            $blogs = mysqli_fetch_all($result, MYSQLI_ASSOC);
            echo '<script>window.location.hash = "#review";</script>'; // Scroll back to the reviews section
...
<div class="container">
    ...
    <swiper-container navigation="true" pagination="true">
        ...
        <swiper-slide class='scroller'>
            <div class="card">
                <div class="card-content">
                    <div>
                        <div class="starsTwo center-align">
                        <?php 
                    ...
                    <span class="card-title center-align"><?php echo htmlspecialchars($blog['title']); ?></span>
            ...
            <div class="text-darken-2">
                ...
                <form action="index.php" method="POST" class="white toggler hide">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <label type="number" class="labels" for="rating">Star Rating</label>
                                <input class="rating" placeholder='type a number between 1 and 5' name="rating" min="0" max="5" value="<?php echo htmlspecialchars($rating) ?>">
